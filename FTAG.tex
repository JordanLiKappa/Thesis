...
\section{Alternative Monte Carlo samples}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \label{sec:FTAG:samples}
...
Another alternative sample with replacing the {\PYTHIA}~8.230 interface
...
\subsection{\texorpdfstring{\btagging}{b-tagging} algorithms output distribution}
...
In terms of statistical gain, taking the 60\% working point scale factor with 2018 data as an example, 
the error is reduced as expected. In the last bin of the $p_{T}$ distribution of scale factors, the error is reduced by 55\%, 
which suggests the success of high-$p_{T}$ selection method. The percentage reduction of error of each bin is given in Tab.\ref{tab:limit}:
