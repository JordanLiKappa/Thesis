...
The di-Higgs production gives a unique access to the coefficients 
...
% The characteristic shapes of the $m_{HH}$ distribution are, 
 % a peak near the $t\bar{t}$ production threshold, or two peaks with 
% a large (small) separation.


% Experimental constraints on the 5 HEFT couplings can rule out the existence 
% of individual benchmarks. However many combinations of the couplings can 
% give rise to the distinct $m_{HH}$ shapes represented by 
% these benchmarks and hence their study is still valuable.
\begin{table}[tbh!]
  \begin{center}
