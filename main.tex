...
tagging a $b$-jet ($b$-jet tagging efficiency, 
$\epsilon_b$) and the probability of mistakenly identifying 
a \cjet or a light-flavour jet as a $b$-jet, 
...
% where the main floating parameter are the $c$-jet efficiency
...
% \includegraphics[width=.45\textwidth]{b_purity/_stats_bjets_purityp_Tjet0GeV.eps
% between the standard selection and the high-$p_T$ selection.\label{fig:b_after_leading}
% \includegraphics[width=.45\textwidth]{b_purity/_stats_bjets_purityp_Tjet1GeV.eps
% purity distribution between the standard selection and the high-$p_T$ selection.\label{fig:b_after_subleading}
% \includegraphics[width=.45\textwidth]{b_purity/tagged_stats_bjets_purityp_Tjet0GeV.eps
...
% \includegraphics[width=.45\textwidth]{b_purity/tagged_stats_bjets_purityp_Tjet1GeV.eps
...
\begin{figure}[H]
	...
	\caption{Standard selection: data versus simulation of the leading and sub-leading jet \pt\ 
...
\begin{table}[ht]
	...
	for the PFlow jets. Events are required to have 
...
requirements for the selection remaining the same. 
...
\begin{table}[ht]
	...
	simulation considering the PFlow jets and the VR-Track jets.}
...
\begin{figure}[!h]
	...
	\caption{High-\pt\ selection: data versus simulation of jets \pt\ for 
...
\begin{figure}[!h]
		...
		\caption{Combined selection: data versus simulation of jets\pt\ for 
		PFlow jets in the left column and for VR-Track jets in the right column.}
...
This cut is to reject most of the true \cjets and true light jet. 
...
The experimental systematics uncertainty is in general very small. 
...
The $1.25 \pm 0.25$ scale factor is applied on events with 3 true $b$-jets. 
...
systematics uncertainty increases as the \pt\ increases. 
...
In some bins the statistical uncertainty can decreases up to 30\%, suggesting that the
