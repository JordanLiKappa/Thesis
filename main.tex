...
% \large
% \chapter{Search for Higgs boson pair production in the \texorpdfstring{\bbtautau} channel}
...
% \clearpage
% \input{DiHiggs/MVA.tex}
% \clearpage
% \input{DiHiggs/Systematics.tex}
% \label{sec:DiHiggs:systematics}
% \clearpage
% \input{DiHiggs/result.tex}
