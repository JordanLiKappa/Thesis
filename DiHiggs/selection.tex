...
The term `Basic selection' refers to selections with at least one \tauhad\ candidate and one lepton passing loose kinematic requirements.
...
The $A \times \epsilon$ for all resonance mass points are shown 
