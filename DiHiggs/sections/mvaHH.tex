The output of a multivariate algorithm is used as the final discriminant for the signal extraction, as described in Section~\ref{sec:fit}.
...
%and the leptoquark mass for the leptoquark-pair analysis. 
